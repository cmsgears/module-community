...
use cmsgears\community\common\services\interfaces\resources\group\IPostService;

use cmsgears\core\common\services\traits\base\ApprovalTrait;

/**
 * PostService provide service methods of group post.
 *
 * @since 1.0.0
 */
class PostService extends \cmsgears\core\common\services\base\ResourceService implements IPostService {
	...
	public static $parentType = CmnGlobal::TYPE_GROUP_POST;
