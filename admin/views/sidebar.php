	...
	<div id="sidebar-community" class="collapsible-tab has-children <?php if( strcmp( $parent, 'sidebar-community' ) == 0 ) echo 'active'; ?>">
		...
		<div class="collapsible-tab-content clear <?php if( strcmp( $parent, 'sidebar-community' ) == 0 ) echo 'expanded visible'; ?>">
			<ul>
				...
				<li class='template <?php if( strcmp( $child, 'template' ) == 0 ) echo 'active';?>'><?= Html::a( "Group Templates", ['/community/group/template/all'] ) ?></li>
				<li class='category <?php if( strcmp( $child, 'category' ) == 0 ) echo 'active';?>'><?= Html::a( "Group Categories", ['/community/group/category/all'] ) ?></li>
				<li class='tag <?php if( strcmp( $child, 'tag' ) == 0 ) echo 'active';?>'><?= Html::a( "Group Tags", ['/community/group/tag/all'] ) ?></li>
