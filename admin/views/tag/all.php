...
$this->title	= 'Tag | ' . $coreProperties->getSiteTitle();
...
<?= DataGrid::widget([
	...
	'grid' => true, 'columns' => [ 'root' => 'colf colf15', 'factor' => [ null ,'x4', 'x2','x5', 'x3'   ] ],
	'gridColumns' => [
		'bulk' => 'Action',
		'name' => 'Name',
...
<?= Popup::widget([
	...
	'data' => [ 'model' => 'Block', 'app' => 'main', 'controller' => 'crud', 'action' => 'bulk', 'url' => "cms/tag/bulk" ]
]) ?>

<?= Popup::widget([
	'title' => 'Delete Block', 'size' => 'medium',
	'templateDir' => Yii::getAlias( '@themes/admin/views/templates/widget/popup/grid' ), 'template' => 'delete',
	'data' => [ 'model' => 'Block', 'app' => 'main', 'controller' => 'crud', 'action' => 'delete', 'url' => "cms/tag/delete?id=" ]
]) ?>
