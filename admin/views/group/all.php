...
<?= DataGrid::widget([
	...
	'grid' => true, 'columns' => [ 'root' => 'colf colf15', 'factor' => [ null, null, 'x2', 'x3', 'x2', null, null, null, 'x3' ] ],
	'gridColumns' => [
		'bulk' => 'Action',
	...
	//'dataView' => "$moduleTemplates/grid/data/group",
	//'cardView' => "$moduleTemplates/grid/cards/group",
