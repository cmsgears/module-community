...
ALTER TABLE `cmg_cmn_message`
	ADD CONSTRAINT `fk_cmn_message_1` FOREIGN KEY (`senderId`) REFERENCES `cmg_core_user` (`id`) ON DELETE CASCADE,
	ADD CONSTRAINT `fk_cmn_message_2` FOREIGN KEY (`recipientId`) REFERENCES `cmg_core_user` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `cmg_cmn_chat_message`
	ADD CONSTRAINT `fk_cmn_chat_message_1` FOREIGN KEY (`chatId`) REFERENCES `cmg_cmn_chat` (`id`) ON DELETE CASCADE,
	ADD CONSTRAINT `fk_cmn_chat_message_2` FOREIGN KEY (`messageId`) REFERENCES `cmg_cmn_chat_message` (`id`) ON DELETE CASCADE;
